    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Conoce al equipo detrás de Hack Nova Web Solutions y nuestra formación académica
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="space-y-4">
                ...
                <div className="space-y-4">
                  ...
                  <Card className="border-2 border-purple-100 bg-purple-50/50">
                    ...
                    <CardContent className="space-y-2">
                      <p><strong>País:</strong> República Dominicana</p>
                      <p><strong>Municipio:</strong> Santo Domingo, Herrera</p>
                      <p><strong>Enfoque:</strong> Comunidades emergentes y emprendedores locales</p>
                    </CardContent>
                  </Card>
                </div>
              </div>
              ...
              <div className="flex items-center justify-center">
                <Image
                  src="/imgs/HackNovaFullLogo.png"
                  width="500"
                  height="400"
                  alt="Universidad Dominicana O&M"
          ...
          <div className="px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Cinco profesionales de Ingeniería en Sistemas comprometidos con la innovación tecnológica
                </p>
              </div>
            </div>
            ...
            <div className="mx-auto grid max-w-6xl items-center gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="border-2 border-green-200 bg-green-50/50 md:col-span-2 lg:col-span-3">
                ...
                <CardContent className="text-center space-y-2">
                  <p><strong>Nombre del Proyecto:</strong> Hack Nova Web Solutions</p>
                  <p><strong>Sustentantes:</strong> 5 estudiantes de Ingeniería en Sistemas</p>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 md:text-xl">
                  Conoce los antecedentes y motivaciones que dieron origen a Hack Nova Web Solutions
                </p>
              </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed">
                      En Hack Nova Web Solutions, creemos firmemente que la tecnología debe estar al 
                      alcance de todos. Nuestra motivación surge de una combinación entre vocación técnica, 
                      compromiso social y visión de futuro como profesionales de Ingeniería en Sistemas.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed">
                      Aspiramos a ser un puente entre la tecnología y los emprendedores locales que, 
                      por falta de recursos o acompañamiento técnico, han quedado rezagados en la era digital, 
                      brindándoles una oportunidad real de crecimiento.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed">
                      Nuestra cercanía generacional y cultural nos permite comunicarnos de forma fluida 
                      con los emprendedores, generando empatía, confianza y colaboración en cada proyecto 
                      que desarrollamos.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-700 leading-relaxed">
                      Nuestra propuesta se basa en soluciones digitales que reducen el uso de materiales físicos, 
                      como volantes y catálogos impresos, contribuyendo a una práctica más responsable y sostenible.
                    </p>
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center text-white">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Contáctanos para conocer más sobre nuestro proyecto y cómo podemos ayudarte
                </p>
              </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-gray-50">
        <p className="text-xs text-gray-600">
          © 2025 Hack Nova Web Solutions - Universidad Dominicana O&M. Todos los derechos reservados.
        </p>
